<?PHP
	...
	$name_path = $uploaddir . '/' . md5 ($_FILES['adjunto']['name']) . (string)(rand(1, 100)) . $_FILES['adjunto']['name'] ;


	if ( ($uploadSize<$maxSize) && (move_uploaded_file($_FILES['adjunto']['tmp_name'], $name_path ))) {
